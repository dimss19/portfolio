...
export default function ContactCTA() {
  ...
  return (
    <section className="py-40 bg-background text-center border-t border-white/5" id="contact" ref={ref}>
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className={`mt-32 pt-20 border-t border-white/5 scroll-fade-up ${isVisible ? "visible" : ""}`}>
